...
func (uiu *UserIdentityUpdate) SetProviderUserID(s string) *UserIdentityUpdate {
	uiu.mutation.SetProviderUserID(s)
	return uiu
}

// SetNillableProviderUserID sets the "provider_user_id" field if the given value is not nil.
func (uiu *UserIdentityUpdate) SetNillableProviderUserID(s *string) *UserIdentityUpdate {
	if s != nil {
		uiu.SetProviderUserID(*s)
	}
	return uiu
}
...
func (uiu *UserIdentityUpdate) SetUserID(id int) *UserIdentityUpdate {
	uiu.mutation.SetUserID(id)
	return uiu
}
...
func (uiu *UserIdentityUpdate) check() error {
	...
	if v, ok := uiu.mutation.ProviderUserID(); ok {
...
func (uiu *UserIdentityUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uiu.mutation.ProviderUserID(); ok {
...
// SetProviderUserID sets the "provider_user_id" field.
func (uiuo *UserIdentityUpdateOne) SetProviderUserID(s string) *UserIdentityUpdateOne {
	uiuo.mutation.SetProviderUserID(s)
	return uiuo
}

// SetNillableProviderUserID sets the "provider_user_id" field if the given value is not nil.
func (uiuo *UserIdentityUpdateOne) SetNillableProviderUserID(s *string) *UserIdentityUpdateOne {
	if s != nil {
		uiuo.SetProviderUserID(*s)
	}
	return uiuo
}
...
// SetUserID sets the "user" edge to the User entity by ID.
func (uiuo *UserIdentityUpdateOne) SetUserID(id int) *UserIdentityUpdateOne {
	uiuo.mutation.SetUserID(id)
	return uiuo
}
...
func (uiuo *UserIdentityUpdateOne) check() error {
	...
	if v, ok := uiuo.mutation.ProviderUserID(); ok {
		if err := useridentity.ProviderUserIDValidator(v); err != nil {
			return &ValidationError{Name: "provider_user_id", err: fmt.Errorf(`ent: validator failed for field "UserIdentity.provider_user_id": %w`, err)}
		}
	}
...
func (uiuo *UserIdentityUpdateOne) sqlSave(ctx context.Context) (_node *UserIdentity, err error) {
	...
	if value, ok := uiuo.mutation.ProviderUserID(); ok {
		_spec.SetField(useridentity.FieldProviderUserID, field.TypeString, value)
	}
