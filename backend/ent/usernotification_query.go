...
func (unq *UserNotificationQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (unq *UserNotificationQuery) FirstIDX(ctx context.Context) int {
...
func (unq *UserNotificationQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (unq *UserNotificationQuery) OnlyIDX(ctx context.Context) int {
...
func (unq *UserNotificationQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (unq *UserNotificationQuery) IDsX(ctx context.Context) []int {
	ids, err := unq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (unq *UserNotificationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usernotification.Table, usernotification.Columns, sqlgraph.NewFieldSpec(usernotification.FieldID, field.TypeInt))
	_spec.From = unq.sql
